...
#    np.testing.assert_allclose(tmp[1][0], 0.00098462898029272805)
    ...
    np.testing.assert_allclose(hagg, 65.73846496428509)
    parea = stats.computeParea(maplayers2['model']['grid'],
                               probthresh=0.2)
    np.testing.assert_allclose(parea, 80.69906185091396)
    ...
    np.testing.assert_allclose(stats2['Median'], 0.0003196329310881202)
    np.testing.assert_allclose(stats2['Std'], 0.049146076928965256)
    np.testing.assert_allclose(stats2['Hagg_0.20g'], 53.07695560636296)
